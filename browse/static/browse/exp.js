$(function () {
    ...
    $("input[value='locus'][id='checkboxColumn']").prop("checked", "true");
    $("input[value='locus'][id='checkboxColumn']").prop("disabled", "disabled");
    $("input[value='genename'][id='checkboxColumn']").prop("checked", "true");
    $("input[value='classnum'][id='checkboxColumn']").prop("checked", "true");
    $("input[value='number_37_vs_26celsius'][id='checkboxColumn']").prop("checked", "true");
    $("input[value='cold_shock'][id='checkboxColumn']").prop("checked", "true");
    $("input[value='heat_shock'][id='checkboxColumn']").prop("checked", "true");
...
function performFunction(item) {
    ...
    if (selectedNumber > 0) {
        ...
        if (functionType == "download") {  //download data
            ...
            $.fileDownload('/browse/exp/download/?selected=' + selected + '&type=' + type)
                .done(function () {
                })
                .fail(function () {
